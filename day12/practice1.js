...
// [매개변수] x, y  [명령어] x+y  [반환값] -
function printSum( x, y ){ // x, y는 매개변수라고 한다. 함수 호출 시 인수/인자 값이 저장되는 변수
    console.log( x + y );
}
printSum( 5, 10 );
...
// [매개변수] name  [명령어] - [반환값] "환영합니다, [name]님!"
function getWelcomeMessage( name ){ // name 매개변수 라고 한다. 매개변수명은 아무거나 정의했다.
    return `환영합니다, ${name}님! `;    
} // f end
...
// [매개변수] -  [명령어] counter의 값을 1씩 증가 [반환값] -
let counter = 0
...
// [매개변수] n [명령어] 1부터 n까지의 숫자를 콘솔에 차례로 출력 
...
// 매개변수 : 이름, 명령어 : userList 전역 배열에 push, 반환 : x
let userList = [] ; // 전역변수
