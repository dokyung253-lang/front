...
// [3] document.quertSelector( ): js에서 특정한 마크업 객체 반환 함수
...
// [4] document.querySelectorAll( "css 선택자" ) :  js에서 특정한 마크업(들 객체) 배열로 반환
let div2 = document.querySelectorAll("ALL")


// [5] .innerHTML : 선택된 DOM객체 내 마크업 사이에 텍스트를 <호출>
let html1 = document.querySelector("#box3").innerHTML
console.log( html1 ); // box3
document.querySelectorAll( "#box3" ).innerHTML = "박스3";// 마크업 사이에 텍스트
