...
// (1) 초기값 : let i = 1;          // i가 11 이면 false이므로 반복문 종료
// (2) 조건문 : i <= 10;
// (3) 증감식 : i++;
// (4) 실행문 : console.log( i );
...
// 초기값 : number.length -1    // 조건문 : index >= 0;
// 증감식 : index --;           // 실행문 : console.log (1);
let numbers = [1, 2, 3, 4, 5];
for( let index = numbers.length -1 ; index >= 0 ; index --){console.log( number[index]); } // 4부터 0까지 감소
