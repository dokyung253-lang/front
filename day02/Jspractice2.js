/*[ JS 실습2 ]
- 문제1:   손님에게 이름과 원하는 음료, 그리고 수량을 순서대로 물어본 후, 모든 정보를 조합하여 바리스타가 볼 수 있도록 콘솔에 주문 내역을 출력하는 프로그램을 만드세요.
- 요구사항
...
- 출력 예시
    ...
    3
*/
 // [요구 정보] 손님의 이름,원하는 음료,주문 수량
let name = prompt("이름");
let menu = prompt("음료");
let count = prompt("주문수량");
