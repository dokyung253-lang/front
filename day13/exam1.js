...
// 버튼 클릭하면 : <button id= "submitBtn">확인 </button>, 
...
function func3( ){
    ...
    // DOM 객체.style.css속석명 = css속성값 // css는 - 하이픈 가능, js - 하이픈 불가능
    // 속성명은 카멜표기법 사용
...
// querySelector() : 1개(객체반환) vs querySelectorAll() : 여러개(배열전환)
...
const products = []; // 전역배열
// 지역변수 대신에 전역변수 선언한 이유: 등록할 때마다 함수는 재실행/ 초기화/ 영구저장 안됨
function func9(){
    // 입력
